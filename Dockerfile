...
# Create the directory to hold all the code needed to build root, geant, rat-pac, etc.
# RUN mkdir /src
...
WORKDIR /src
RUN git clone https://github.com/AIT-WATCHMAN/rat-pac-g4.10.03.git rat-pac
WORKDIR /src/rat-pac
